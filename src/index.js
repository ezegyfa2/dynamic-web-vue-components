export default {
	install(Vue) {
		...
		Vue.component('dynamic-web-input', require('./ContactForm/DynamicInput/Component.vue').default);
		Vue.component('dynamic-web-fit-height-input', require('./ContactForm/FitHeightDynamicInput/Component.vue').default);
